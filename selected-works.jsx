...
const SW_PROJECTS = [
{
  ...
  gallery: ['assets/tropfin-web-02.jpg', 'assets/tropfin-web-03.jpg', 'assets/tropfin-web-06.jpg', 'assets/tropfin-01.jpg', 'assets/tropfin-07.jpg', 'assets/tropfin-09.jpg', 'assets/tropfin-10.jpg', 'assets/tropfin-08.jpg', 'assets/tropfin-11.jpg', 'assets/tropfin-06.jpg', 'assets/tropfin-05.jpg', 'assets/tropfin-12.jpg'],
  num: '01',
  title: 'Tropfin',
...
},
{
  ...
  summary: 'A behavioural app that turns everyday low-carbon choices such as recycling, transit and energy use into a savings wallet you can actually watch grow.',
  role: 'UX/UI Designer',
  ...
  problem: 'Climate apps either preach or gamify badly. Neither moves the daily decision (bike or car, recycle or trash) at the moment it matters.',
...
},
{
  ...
  type: 'Self-initiated',
  awards: [],
  summary: 'An interactive mobile game about bipolar disorder. You play a small ship across four moods: happiness, sadness, mania and depression. Each one rewriting the physics of the sea.',
...
},
{
  ...
  type: 'Product',
  awards: [],
  summary: 'Web platform for Thailand\'s Geo-Informatics agency mapping the ASEAN co-cultural heritage of the Suvarnabhumi region: historical sites, civilisations and ancient trade routes.',
  role: 'UI Designer',
...
},
{
  ...
  problem: 'Existing uniform pieces were inconsistent across role and season. Shirts, caps, aprons and jackets were all sourced separately, with no shared spec or grading.',
...
{
  id: 'aia-isay',
  hero: 'assets/aia-hero.jpg',
  midImage2: 'assets/aia-banners.gif',
  midImage: 'assets/aia-journey.jpg',
  logo: 'assets/logo-aia.png',
  num: '10',
  title: 'AIA Thailand — iSAY App',
  kicker: 'Graphic Design · In-app Content — Graphic Designer',
  year: '2022 — 2023',
  type: 'Graphic',
  awards: [],
  summary: 'A year of monthly in-app banners and supporting content materials for iSAY, AIA Thailand\'s agent application.',
  highlight: 'Asia\'s No. 1 Life Insurer',
  role: 'Graphic Designer',
  context: 'AIA is the largest life insurer in Asia: the biggest independent publicly listed pan-Asian life insurance group, founded in 1919 and active in 18 markets, with Thailand among its largest. From March 2022 to March 2023 I was the graphic designer on iSAY, the internal application AIA Thailand\'s agents use every day, working out of Bangkok.',
  problem: 'The app needed fresh in-app banners every month, each tied to a campaign, product push or agent incentive, and each had to read instantly on a phone screen while staying inside a strict corporate brand.',
  approach: 'Set up a monthly banner system on the AIA brand kit: fixed safe zones, a type scale tuned for small screens, and a rotating set of illustration and photo treatments so each month felt new without drifting off-brand. Produced the supporting content materials alongside so campaigns landed as one set.',
  outcome: 'Twelve months of banners and content shipped on schedule inside the iSAY app, with a reusable template set handed over to the in-house team.',
  toolkit: ['Adobe After Effects', 'Adobe Illustrator', 'Photoshop']
},
{
  id: 'grabfood-msize',
